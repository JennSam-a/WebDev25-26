...
function calcDist() {
    ...
    op.innerHTML = `Distance between points (${x1}, ${y1}) and (${x2}, ${y2}) is ${d.toFixed(2)}`;
}
...
function calcCompound() {
    ...
    let op = document.getElementById("ciOutput");
    op.innerHTML = `Final amount after ${t} years is $${A.toFixed(2)}`;
}
